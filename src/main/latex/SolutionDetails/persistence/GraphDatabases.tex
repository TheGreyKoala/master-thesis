\subsection{Graphdatenbanken}
    ...
    Ein bekannter Vertreter ist Cypher, die ursprünglich von Neo4J eingeführt wurde
    \cite[Kapitel 3]{neo4j:documentation} und für die es Bestrebungen zur Standardisierung
    gibt\footnote{vgl. \url{https://www.opencypher.org/}}.
