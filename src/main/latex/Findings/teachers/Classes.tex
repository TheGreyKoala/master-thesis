\subsection{Das {\classificationModel}}
    ...
    \lstinputlisting[
        ...
        caption=Das {\classificationModel} der Webseite \"uber Mitarbeiter (1),
        language=wccdl,
    ...
    die sowohl ein {\referenceFeature} für das Bild als auch für den Link enthält.
    ...
    \lstinputlisting[
        ...
        caption=Das {\classificationModel} der Webseite \"uber Mitarbeiter (2),
        language=wccdl,
        inputencoding=utf8/latin1,
        style=wccdl
    ...
    \lstinputlisting[
        ...
        caption=Die HTML-Repräsentation eines Mitarbeiters des Portals \acrshort{babw},
        style=html
