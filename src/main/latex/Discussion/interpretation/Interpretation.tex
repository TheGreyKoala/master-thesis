\section{Interpretation und Bewertung}
    % TODO: Problem mit deutlich verschobenen Telefonnummern. Bug, aber Fix würde Ansatz mit innerText kaputt machen, sodass Alg. für Drittsysteme weniger nachvollziehbar.
    ...
    \input{Discussion/interpretation/Language}
    \input{Discussion/interpretation/ClassificationModel}
    \input{Discussion/interpretation/Selectors}
    \input{Discussion/interpretation/Database}
    \input{Discussion/interpretation/Annotations}
