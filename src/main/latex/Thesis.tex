\documentclass[abstract=on,titlepage,twoside,openright]{scrreprt}
...
\begin{document}
	...
	\include{SolutionConcept}
	\include{SolutionDetails}
	\include{Findings}
	\include{FindingsDiscussion}
	\include{SummaryAndOutlook}
