\section{\wordpress}
    ...
    \subsection{Posts und Pages}
        ...
        und Pages \cite[Kapitel "`Pages"']{wordpress:codex}.
        ...
        \cite[Kapitel "`Post Types"']{wordpress:codex}:
    ...
    \subsection{Vorlagen und Themes}
        ...
        \cite[Kapitel "`Templates"']{wordpress:codex}.
    ...
    \subsection{Plugins}
        ...
        \cite[Kapitel "`Shortcode API"']{wordpress:codex}.
