\section{Klassifizierung einer Webseite}
    ...
    \subsection{Selektoren}
        ...
        Für {\referenceFeature}s ermittelt das \gls{wccs} die {\resource},
        die durch dieses Element angesprochen wird.
        % TODO Diese letzte Unterscheidung muss schon hier stehen, kommt das später nochmal irgendwo?
...
<article>
    <h3>Article 3 Heading<h3>
        ...
        % TODO: Braucht man dieses Bsp. oder reicht das in der Einleitung?
        ...
        was sich zur Klassifizierung einer Seite als Ganzes und von {\referenceFeature}s eignet.
