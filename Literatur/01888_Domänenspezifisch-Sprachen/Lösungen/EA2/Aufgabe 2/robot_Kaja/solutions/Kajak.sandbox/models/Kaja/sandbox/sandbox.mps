...
<model ref="r:1a01fdc1-6171-4a9b-86c9-e6b8bbdfe8af(Kaja.sandbox.sandbox)">
  ...
  <registry>
    ...
    <language id="049a08c5-1fe5-43cc-bd99-8b46d641d7f5" name="jetbrains.mps.samples.Kaja">
      ...
      <concept id="8047764842124111581" name="jetbrains.mps.samples.Kaja.structure.HalfLeftTurn" flags="ng" index="1500Ax" />
  ...
  <node concept="1x_AGo" id="6YJpRKEIhQ1">
    <property role="TrG5h" value="DiagonalMovement" />
    <node concept="2C6hJS" id="6YJpRKEIhQ2" role="1x_AGi">
      <node concept="24I$Sd" id="6YJpRKEIiXh" role="2C6hI7">
        <property role="24I$TN" value="5" />
        <property role="24I$TM" value="6" />
      </node>
      <node concept="2C1RJh" id="6YJpRKEIiXk" role="2C6hI7" />
      <node concept="2C1pOB" id="6YJpRKEIiXr" role="2C6hI7">
        <node concept="2C1s_R" id="6YJpRKEIiXs" role="2C1pO_">
          <node concept="2C15Q6" id="6YJpRKEIiXt" role="2C1s_O">
            <node concept="2C17Mc" id="6YJpRKEIiXu" role="2C15Q5" />
          </node>
        </node>
        <node concept="2C6hJS" id="6YJpRKEIiXv" role="2C1pO$">
          <node concept="2C1uTc" id="6YJpRKEIiXw" role="2C6hI7" />
        </node>
      </node>
      <node concept="2C1RJh" id="6YJpRKEIiXn" role="2C6hI7" />
      <node concept="2C1pOB" id="6YJpRKEIiXP" role="2C6hI7">
        <node concept="2C1s_R" id="6YJpRKEIiXQ" role="2C1pO_">
          <node concept="2C1t7F" id="6YJpRKEIiXR" role="2C1s_O" />
        </node>
        <node concept="2C6hJS" id="6YJpRKEIiXS" role="2C1pO$">
          <node concept="1x_AGW" id="6YJpRKEIiXT" role="2C6hI7" />
        </node>
      </node>
      <node concept="2C1RJh" id="6YJpRKEIiXE" role="2C6hI7" />
      <node concept="2C1uTc" id="6YJpRKEIjuR" role="2C6hI7" />
      <node concept="1500Ax" id="6YJpRKEIjvr" role="2C6hI7" />
      <node concept="2C1RJh" id="6YJpRKEIjvI" role="2C6hI7" />
      <node concept="2C1pOB" id="6YJpRKEIjwl" role="2C6hI7">
        <node concept="2C6hJS" id="6YJpRKEIjwn" role="2C1pO$">
          <node concept="1x_AGW" id="6YJpRKEIjxD" role="2C6hI7" />
        </node>
        <node concept="2C1s_R" id="6YJpRKEIjwK" role="2C1pO_">
          <node concept="1b7g51" id="6YJpRKEIjwQ" role="2C1s_O" />
        </node>
      </node>
    </node>
  </node>
