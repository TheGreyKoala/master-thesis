  ...
  public Collection<ConceptEditor> getDeclaredEditors(SAbstractConcept concept) {
    {
      ...
      if (SConceptOperations.isExactly(SNodeOperations.asSConcept(cncpt), MetaAdapterFactory.getConcept(0x49a08c51fe543ccL, 0xbd998b46d641d7f5L, 0x6faf677c2aaf6eddL, "jetbrains.mps.samples.Kaja.structure.HalfLeftTurn"))) {
        return Collections.<ConceptEditor>singletonList(new HalfLeftTurn_Editor());
      }
