...
public class Mappingmain extends MapConfigBase implements TemplateMappingConfiguration {
  ...
  public final class ReductionRule22 extends ReductionRuleBase {
    public ReductionRule22() {
      super(new SNodePointer("r:3ab3501c-2f4b-48e6-9b6c-e31ff8ef3185(jetbrains.mps.samples.Kaja.generator.template.main@generator)", "8047764842124112066"), MetaAdapterFactory.getConcept(0x49a08c51fe543ccL, 0xbd998b46d641d7f5L, 0x6faf677c2aaf6eddL, "jetbrains.mps.samples.Kaja.structure.HalfLeftTurn"), false);
    }
    @Override
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      final TemplateExecutionEnvironment environment = context.getEnvironment();
      Collection<SNode> tlist1 = new Templatereduce__HalfLeftTurn().apply(environment, context);
      return tlist1;
    }
  }
